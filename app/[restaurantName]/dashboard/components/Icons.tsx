// app/[restaurantName]/dashboard/components/Icons.tsx

//ايقونات التبويبات في لوحة التحكم
'use client';
...
// أيقونة الإعلانات
export function PromoIcon({ className = "w-5 h-5" }: { className?: string }) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
// أيقونة التوصيل
export function DeliveryIcon({ className = "w-5 h-5" }: { className?: string }) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
// أيقونة الأرباح
export function ProfitsIcon({ className = "w-5 h-5" }: { className?: string }) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
// أيقونة الموظفين
export function EmployeesIcon({ className = "w-5 h-5" }: { className?: string }) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
// app/[restaurantName]/dashboard/components/Icons.tsx (إضافة)
